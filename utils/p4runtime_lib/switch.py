...
sys.path.append('/opt/bf-sde-9.7.0/install/lib/python3.6/site-packages/')
...
class SwitchConnection(object):
    ...
    def shutdown(self):
        ...
        try:
            ...
            print("Switch Thread wasn't started")
    ...
    def build_tofino_config(self, prog_name, bin_path, cxt_json_path):
        ...
        with open(bin_path, 'rb') as bin_f:
            with open(cxt_json_path, 'r') as cxt_json_f:
                ...
                device_config.device_data += bytes(prog_name, encoding="raw_unicode_escape")
                ...
                device_config.device_data += bytes(cxt_json, encoding="raw_unicode_escape")
